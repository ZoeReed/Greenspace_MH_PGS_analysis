######################################
##Script to test the association between the Wellbeing PRS (at multiple thresholds) and the Greenspace variable
...
Greenspace_Well_PRS_lm_results<-list()
i<-0
...
for(risk_score in scores){
	...
	new$N<-nobs(summ_lm)
	Greenspace_Well_PRS_lm_results<-rbind(Greenspace_Well_PRS_lm_results, new)
	}

write.csv(Greenspace_Well_PRS_lm_results, file="/path/Greenspace_Well_PRS_results_lm.csv", row.names=F, quote=F)
...
Greenspace_Well_PRS_msoa_results_mundlak_risk_score<-list()
Greenspace_Well_PRS_msoa_results_mundlak_risk_score_mean<-list()
i<-0
...
for(risk_score in scores){
	...
	Greenspace_Well_PRS_msoa_results_mundlak_risk_score<-rbind(Greenspace_Well_PRS_msoa_results_mundlak_risk_score, new)
	Greenspace_Well_PRS_msoa_results_mundlak_risk_score_mean<-rbind(Greenspace_Well_PRS_msoa_results_mundlak_risk_score_mean, new2)
}

write.csv(Greenspace_Well_PRS_msoa_results_mundlak_risk_score, file="/path/Greenspace_Well_PRS_MSOA_results_Mundlak_risk_score.csv", row.names=F, quote=F)

write.csv(Greenspace_Well_PRS_msoa_results_mundlak_risk_score_mean, file="/path/Greenspace_Well_PRS_MSOA_results_Mundlak_risk_score_mean.csv", row.names=F, quote=F)

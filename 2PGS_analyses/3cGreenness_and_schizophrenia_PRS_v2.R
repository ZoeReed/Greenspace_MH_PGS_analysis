######################################
##Script to test the association between the Schizophrenia PRS (at multiple thresholds) and the NDVI variable
...
Greenness_Scz_PRS_lm_results<-list()
i<-0
...
for(risk_score in scores){
	...
	new$N<-nobs(summ_lm)
	Greenness_Scz_PRS_lm_results<-rbind(Greenness_Scz_PRS_lm_results, new)
	}

write.csv(Greenness_Scz_PRS_lm_results, file="/path/Greenness_Scz_PRS_results_lm.csv", row.names=F, quote=F)
...
Greenness_Scz_PRS_msoa_results_mundlak_risk_score<-list()
Greenness_Scz_PRS_msoa_results_mundlak_risk_score_mean<-list()
i<-0
...
for(risk_score in scores){
	...
	Greenness_Scz_PRS_msoa_results_mundlak_risk_score<-rbind(Greenness_Scz_PRS_msoa_results_mundlak_risk_score, new)
	Greenness_Scz_PRS_msoa_results_mundlak_risk_score_mean<-rbind(Greenness_Scz_PRS_msoa_results_mundlak_risk_score_mean, new2)
}

write.csv(Greenness_Scz_PRS_msoa_results_mundlak_risk_score, file="/path/Greenness_Scz_PRS_MSOA_results_Mundlak_risk_score.csv", row.names=F, quote=F)

write.csv(Greenness_Scz_PRS_msoa_results_mundlak_risk_score_mean, file="/path/Greenness_Scz_PRS_MSOA_results_Mundlak_risk_score_mean.csv", row.names=F, quote=F)

...
pcs<-read.table(file="/filepath/100PCs_covariates.txt", header=T)
...
write.table(ndvi_results_final, file ="/filepath/ndvi_pc_R2.csv", row.names = FALSE, append = FALSE, col.names = TRUE, sep = "\t ", quote=F)
...
write.table(greenspace_results_final, file ="/filepath/greenspace_pc_R2.csv", row.names = FALSE, append = FALSE, col.names = TRUE, sep = "\t ", quote=F)
...
pdf("/filepath/rsquared_for_pcs_greenness.pdf",width=20, height=10)

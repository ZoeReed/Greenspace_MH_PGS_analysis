######################################
##Script to match NDVI dataset to area level variables
...
#Load UK biobank data for NDVI (from script 2a)
load("/filepath/green_bump_biobank_final_20200805.RData")
...
save(green_data, file="/filepath/green_bump_biobank_final_census_20200805.RData")

writeOGR(obj=msoa, dsn="/filepath/", layer="Census_MSOA", driver="ESRI Shapefile")

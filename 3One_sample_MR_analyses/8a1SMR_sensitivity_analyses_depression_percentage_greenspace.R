######################################
##Script to conduct onne sample MR sensitivity analyses (IVW, MR-Egger and LADreg) for depression and percentage greenspace
...
dep_diag<-read.csv("//filepath/Percentage_GS_data_dep_diag_adjusted_summary_data_ukb.csv", header=T)

#MHQ depression
dep_MHQ<-read.csv("/filepath/Percentage_GS_data_MHQ_dep_adjusted_summary_data_ukb.csv", header=T)
...
dep_diag_GS = data.frame(Estimates, LCIs, UCIs, pval,fsNigx,
                                row.names=c("IVW","MR-Egger","LADreg"))
...
dep_MHQ_GS = data.frame(Estimates, LCIs, UCIs, pval,fsNigx,
                                row.names=c("IVW","MR-Egger","LADreg"))
